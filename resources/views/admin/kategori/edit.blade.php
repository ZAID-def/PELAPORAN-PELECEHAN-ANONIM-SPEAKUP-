...
<head>
    ...
    <title>Edit Kategori - SpeakUp Admin</title>
        ...
        <main class="flex-1 flex flex-col overflow-hidden">
            ...
            <header class="bg-white border-b border-gray-200 px-8 py-5 flex items-center justify-between">
                <div>
                    ...
                    <h1 class="text-2xl font-bold text-gray-900">Edit Kategori Jenis Kejadian</h1>
                </div>
                <form action="{{ route('admin.logout') }}" method="POST">
                    @csrf
                        ...
                        <div class="bg-gradient-to-r from-amber-500 to-orange-500 px-8 py-6">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-orange-100 text-sm">Ubah data kategori: <span class="font-semibold">{{ $kategori->nama_kategori }}</span></p>
                                </div>
                            </div>
                        </div>

                        <!-- Form Body -->
                        <form action="{{ route('admin.kategori.update', $kategori->id) }}" method="POST" id="form-edit">
                            @csrf
                            @method('PUT')
                            <div class="px-8 py-6 space-y-6">
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <input
                                            ...
                                            maxlength="255"
                                            required
                                            class="w-full pl-10 pr-4 py-3 border @error('nama_kategori') border-red-400 bg-red-50 @else border-gray-300 @enderror rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-amber-500 transition"
                                        >
                                    </div>
                                    @error('nama_kategori')
                                ...
                                <div>
                                    ...
                                    <textarea
                                        ...
                                        class="w-full px-4 py-3 border @error('deskripsi') border-red-400 bg-red-50 @else border-gray-300 @enderror rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-amber-500 transition resize-none"
                                ...
                                <!-- Status Aktif -->
                                <div class="flex items-start gap-4 bg-amber-50 rounded-xl p-4 border border-amber-100">
                                    <div class="flex items-center h-5 mt-0.5">
                                        <input
                                            ...
                                            class="h-5 w-5 rounded border-gray-300 text-amber-500 focus:ring-amber-500 cursor-pointer"
                                        >
                                    </div>
                                    <div>
                                        <label for="is_active" class="text-sm font-semibold text-gray-800 cursor-pointer">Aktifkan Kategori</label>
                                        <p class="text-xs text-gray-500 mt-0.5">Jika dicentang, kategori ini akan tampil sebagai pilihan di halaman lapor.</p>
                                    </div>
                                </div>
                            ...
                            <div class="px-8 py-5 bg-gray-50 border-t border-gray-200 flex items-center justify-between gap-3">
                                <a href="{{ route('admin.kategori.index') }}" class="flex items-center gap-2 px-5 py-2.5 rounded-xl border border-gray-300 text-gray-700 hover:bg-gray-100 transition text-sm font-medium">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                ...
                                <button
                                    type="submit"
                                    id="btn-submit"
                                    class="flex items-center gap-2 px-6 py-2.5 rounded-xl bg-amber-500 text-white hover:bg-amber-600 active:bg-amber-700 transition text-sm font-semibold shadow-sm hover:shadow-md"
                                >
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
